...
export const services: ServiceData[] = [
  ...
  },
  {
    slug: 'design-build',
    name: 'Design-Build',
    tagline: 'Architecture and construction under one roof. One team. One contract.',
    description: 'In-house architecture and construction integrated from day one. No finger-pointing between architect and builder. No coordination gaps. Faster timelines, fewer problems, better results.',
    features: [
      { title: 'In-House Architecture', description: 'Our architects and builders work in the same office, on the same team.' },
      { title: 'Single Contract', description: 'One agreement covers design and construction. Simpler, faster, less risk.' },
      { title: 'Faster Timelines', description: 'Design and construction overlap. No waiting for one team to finish before the next starts.' },
      { title: 'Coordinated Decisions', description: 'Every design decision is evaluated for buildability and cost in real time.' },
    ],
    process: [
      { step: 1, title: 'Programming', description: 'We understand your operations and translate them into a space plan.' },
      { step: 2, title: 'Schematic Design', description: 'Floor plans, elevations, and a locked budget — before detailed drawings begin.' },
      { step: 3, title: 'Design Development', description: 'Materials, finishes, and systems selected with cost implications clear.' },
      { step: 4, title: 'Construction', description: 'Seamless handoff from design to build — same team, same accountability.' },
    ],
    whoItsFor: 'Business owners who want one team responsible for the entire project — from first sketch to move-in day.',
    faq: [
      { question: 'Do I still need my own architect?', answer: 'No. Our in-house design team handles architecture, interior design, and space planning. You get everything under one contract.' },
      { question: 'Is design-build more expensive?', answer: 'Usually less expensive. Eliminating coordination gaps and redesigns saves 10-15% compared to traditional design-bid-build.' },
      { question: 'Can I see the design before committing to construction?', answer: 'Absolutely. We present schematic designs with a locked budget before you commit to full construction.' },
