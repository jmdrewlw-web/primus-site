...
export function organizationSchema() {
  return {
    ...
    description: 'Commercial general contractor specializing in design-build, construction management, and development advisory. 500+ projects, 24 years, $770M delivered.',
